...
const FlexiblePaymentSection = () => (
  <section className={styles.container}>
    ...
    <p className={`${styles.termstext} body2`}>
      NOTE: Only applies to bookings made a minimum of 95 days before the trip. For bookings made within 95 days before
      the trip, see our <Link href="/terms-and-conditions">Terms and conditions</Link>.
    </p>
  </section>
);
